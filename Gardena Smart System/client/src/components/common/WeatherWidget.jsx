	...
	return (
		<div className='weather-widget'>
			...
			<div className='weather-status-grid'>
				...
				<p>
					Odczuwalna: <span>{weatherData.main.feels_like.toFixed(1)}</span>°C
				</p>
				<p>
				...
				{weatherData.rain && (
					<>
						{weatherData.rain['1h'] && (
							<>
								<p>
									Opady deszczu (1h): <span>{weatherData.rain['1h']}</span> mm
								</p>
				...
				{weatherData.snow && (
					<>
						{weatherData.snow['1h'] && (
							<>
								<p>
									Opady śniegu (1h): <span>{weatherData.snow['1h']}</span> mm
								</p>
